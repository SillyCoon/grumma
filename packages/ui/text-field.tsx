...
const TextFieldTextArea = <T extends ValidComponent = "textarea">(
  ...
  return (
    <TextFieldPrimitive.TextArea
      class={cn(
        "flex min-h-20 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary disabled:cursor-not-allowed disabled:opacity-50",
        local.class,
      )}
      {...others}
    />
